...
namespace Bigfoot\Bundle\ContentBundle\Form\Type\Page\Sidebar;
...
class Sidebar2Type extends AbstractType
{
    /**
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(
            array(
                'data_class' => 'Bigfoot\Bundle\ContentBundle\Entity\Page\Sidebar\Sidebar2'
            )
        );
    }
    ...
    {
        return 'admin_page_sidebar_sidebar_2';
    }
}
