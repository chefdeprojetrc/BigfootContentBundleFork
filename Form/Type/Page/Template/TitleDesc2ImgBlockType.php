...
class TitleDesc2ImgBlockType extends AbstractType
{
    /**
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(
            array(
                'data_class' => 'Bigfoot\Bundle\ContentBundle\Entity\Page\Template\TitleDesc2ImgBlock',
                'template'   => '',
                'templates'  => ''
            )
        );
    ...
    {
        return 'admin_page_template_title_desc2_img_block';
    }
}
