...
class TitleDesc2ImgType extends AbstractType
{
    /**
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(
            array(
                'data_class' => 'Bigfoot\Bundle\ContentBundle\Entity\Page\Template\TitleDesc2Img',
                'template'   => '',
                'templates'  => ''
            )
        );
    ...
    {
        return 'admin_page_template_title_desc2_img';
    }
}
