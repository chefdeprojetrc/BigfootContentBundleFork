...
namespace Bigfoot\Bundle\ContentBundle\Form\Type\Page\TitleDescImgSidebar;
...
class TitleDescImgSidebar1Type extends AbstractType
{
    /**
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(
            array(
                'data_class' => 'Bigfoot\Bundle\ContentBundle\Entity\Page\TitleDescImgSidebar\TitleDescImgSidebar1'
            )
        );
    }
    ...
    {
        return 'admin_page_title_desc_img_sidebar_title_desc_img_sidebar_1';
    }
}
