...
class TitleImgBlockType extends AbstractType
{
    /**
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(
            array(
                'data_class' => 'Bigfoot\Bundle\ContentBundle\Entity\Sidebar\Template\TitleImgBlock',
                'template'   => '',
                'templates'  => ''
            )
        );
    ...
    {
        return 'admin_sidebar_template_title_img_block';
    }
}
