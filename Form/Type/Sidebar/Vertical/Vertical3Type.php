...
namespace Bigfoot\Bundle\ContentBundle\Form\Type\Sidebar\Vertical;
...
class Vertical3Type extends AbstractType
{
    /**
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(
            array(
                'data_class' => 'Bigfoot\Bundle\ContentBundle\Entity\Sidebar\Vertical\Vertical3'
            )
        );
    }
    ...
    {
        return 'admin_sidebar_vertical_vertical_3';
    }
}
